  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <Link
        to="/Categories"
        className={`inline-flex items-center border-b-2 ${
          location.pathname.includes('/Categories') ? 'border-indigo-500' : 'border-transparent'
        } px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700`}
      >
        Categories
      </Link>
            <Link href="#" className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Reviews</Link>
            <Link href="#" className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Upgrades</Link>
          </div>
        </div>
